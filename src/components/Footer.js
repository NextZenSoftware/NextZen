...
const Footer = () => {
  return (
    <div className="bg-white w-full h-auto px-4 text-black pt-8 pb-16 flex flex-col md:flex-row flex-wrap justify-evenly md:px-12">
      <div className="mb-8 md:mb-0">
        ...
        <div>
          <p className="text-sm text-center mt-4 hover:text-blue-700 cursor-pointer transition-all duration-200">
      ...
      <div className="mb-8 md:mb-0">
        ...
        <div className="flex flex-col items-center">
          <div className="flex gap-3 mt-5 hover:text-blue-700 cursor-pointer transition-all duration-200">
            <FaLocationDot size={25} />
            <p className="text-sm text-center">
              2nd Floor, Extra Mart, Sarojni Delhi
              <br />
              Twin Tower, Sector 16B, Delhi, India
            </p>
          </div>
      ...
      <div className="mb-8 md:mb-0">
        ...
        <div className="flex flex-col items-center">
          <p className="text-sm mt-4 hover:text-blue-700 cursor-pointer transition-all duration-200">
            <Link href={"/about"}> About us</Link>
          </p>
          <p className="text-sm hover:text-blue-700 cursor-pointer transition-all duration-200">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="mt-2">
          <span className="text-center text-sm mt-6 hover:text-blue-700 cursor-pointer">
            © 2024 NextZen. All rights reserved.
          </span>
        </div>
      </div>
    </div>
